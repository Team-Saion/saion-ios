//
//  BottomSheetPresentationVC.swift
//  DesignSystem
//
...
open class BottomSheetPresentationVC: UIViewController {
...
extension BottomSheetPresentationVC: UIViewControllerTransitioningDelegate {
    /// 프레젠테이션 컨트롤러 설정
